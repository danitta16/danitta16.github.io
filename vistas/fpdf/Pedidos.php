...
$consulta_reporte_pedidos = $pdo->query("SELECT p.idpedido, p.fechapedido, p.horapedido, p.estadopedido, 
...
$nombreArchivo = 'Pedidos_' . $fechaHoy . '.pdf'; // Concatenar la fecha al nombre del archivo
