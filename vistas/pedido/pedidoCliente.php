...
<div class="well well-sm text-right">
    <a class="btn btn-primary" href="?c=PedidoCliente&a=Crud">Nuevo pedido</a>
</div>
<div>
    <a href="fpdf/PedidosCliente.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf"></i> Generar reportes</a>
</div>
...
<table class="table table-striped">
    ...
    <tbody>
        <?php foreach ($this->model->ListarPorId($_SESSION["id"]) as $p): ?>
            <tr>
                ...
                <td>
                    <a href="?c=PedidoCliente&a=Crud&idpedido=<?php echo $p->idpedido; ?>">Editar</a>
                </td>
                <td>
