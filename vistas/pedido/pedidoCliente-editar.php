...
<ol class="breadcrumb">
    <li><a href="?c=PedidoCliente">Pedidos</a></li>
    <li class="active"><?php echo !empty($alm->idPedido) ? $alm->fechapedido : 'Nuevo Pedido'; ?></li>
</ol>

<form id="frm-pedido" action="?c=PedidoCliente&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
    <input type="hidden" name="idusuarioFK" value="<?php echo $_SESSION["id"]; ?>" />
    </div>

    <div class="form-group">
        <label>Id Usuario</label>
        <input type="text" value="<?php echo $_SESSION["id"]; ?>" class="form-control" placeholder="Ingrese el id del usuario" readonly />
    </div>
